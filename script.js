document.addEventListener('DOMContentLoaded', () => {
    ...
    if (calendarGrid) {
        // August 2026 starts on a Saturday (Day 6, considering 0=Sunday)
        const daysInMonth = 31;
        const startDayIndex = 6; 
        
        // Mock Events for August 2026
        const events = {
        ...
        for (let i = 1; i <= daysInMonth; i++) {
            ...
            dayCell.style.animationDelay = `${(startDayIndex + i) * 0.03}s`;
            ...
            if (hasEvent) {
                ...
                dayCell.addEventListener('click', () => {
                    ...
                    panelTitle.textContent = `${i} de Agosto`;
                    panelDesc.textContent = 'Nenhum evento programado. Entre em contato para consultar a disponibilidade desta data!';
                    panel.classList.remove('hidden');
                    panelLink.style.display = 'inline-flex';
                    panelLink.href = `https://wa.me/5512992538126?text=Olá,%20gostaria%20de%20saber%20sobre%20a%20disponibilidade%20para%20o%20dia%20${i}%20de%20Agosto!`;
